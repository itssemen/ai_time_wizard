...
*   **Текст:**
    *   **Текущий статус:** Фокус на MVP – сбор обратной связи, подтверждение востребованности.
...
*   **Визуал:** Стилизованные иконки для каждой категории метрик (например, магнит для Acquisition, лампочка для Activation, круговая стрелка для Retention, график для Engagement, звезда для Quality, монета для Monetization).
